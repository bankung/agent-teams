# Decisions archive — agent-teams (entries 2026-05-04 → 2026-05-19)

> Split from `decisions.md` on 2026-06-02 (Kanban #1583) to shrink the per-session bootstrap read. Newest-first, same format + scope as decisions.md. **Grep here for historical / closed decisions;** active + recent decisions live in `decisions.md`.
