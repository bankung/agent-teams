...
#
# Lead-side responsibility: bootstrap section of AGENTS.md must write the project_id
...
# Resolve repo root from this script's location: .codex/hooks/<script>.ps1 -> ..\..
...
See: .codex/hooks/block-spawn-on-killed-project.ps1
"@
