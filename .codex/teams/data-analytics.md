...
This playbook orchestrates the Data Analytics team. For universal Lead rules, see root `AGENTS.md`. This file covers Data Analytics-specific roster, lifecycle, and conventions.
...
Definitions: [.codex/agents/](.codex/agents/) (the `bi-*`, `sql-*`, `dashboard-*`, `analytics-platform-*` files).
...
4. **Spawn via the Agent tool** — see [.codex/docs/spawn-template.md](.codex/docs/spawn-template.md). Independent specialists can spawn in parallel.
