...
1. **Spawn brief should include this rule explicitly** at the end:
   > "Output format: structured markdown only. NO narrative preamble. Forbidden phrases per .codex/docs/output-compression-discipline.md. Report sections only."

2. **Agent .md files should reference this doc** in their output format section (`see .codex/docs/output-compression-discipline.md`)
...
- Companion: .codex/docs/url-deeplink-tricks.md (Mode A compose+send cost reduction)
