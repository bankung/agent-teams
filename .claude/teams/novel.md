...
This playbook orchestrates the novel team. For universal Lead rules, see root `CLAUDE.md`. This file covers novel-specific roster, lifecycle, and conventions.
