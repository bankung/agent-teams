...
This playbook orchestrates the SEO team. For universal Lead rules, see root `CLAUDE.md`. This file covers SEO-specific roster, lifecycle, and conventions.
...
4. **Spawn via the Agent tool** — see [.claude/docs/spawn-template.md](.claude/docs/spawn-template.md). Independent agents can spawn in parallel.
