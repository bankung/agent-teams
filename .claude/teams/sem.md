...
This playbook orchestrates the SEM team. For universal Lead rules, see root `CLAUDE.md`. This file covers SEM-specific roster, lifecycle, and conventions.
...
4. **Spawn via the Agent tool** — see [.claude/docs/spawn-template.md](.claude/docs/spawn-template.md). Independent platform specialists can spawn in parallel.
