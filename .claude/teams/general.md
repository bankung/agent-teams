...
This playbook orchestrates the general team. For universal Lead rules, see root `CLAUDE.md`. This file covers general-specific roster, decision logic, and lifecycle.
...
4. **Spawn via the Agent tool** — see [.claude/docs/spawn-template.md](.claude/docs/spawn-template.md). Include the escalation protocol: `general` should STOP and escalate if they discover domain boundaries.
