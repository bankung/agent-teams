...
that is an optional future graduation, not v1. New skill files are picked up after a Claude Code
**restart** (creating the `.claude/skills/` dir for the first time requires a restart to begin watching it).
