...
# /zb-audit — on-demand project health audit
...
- **zb-bind** — establishes the project binding that zb-audit defaults to; run before zb-audit when switching projects.
- **zb-tasks-next** — complements the audit by surfacing the next actionable task for the project after reviewing its health.
