...
# /zb-task-attach — link a task to a milestone
...
## Related skills
- `zb-milestone-create` — create the milestone before attaching tasks to it
- `zb-milestones` — list all milestones to find the right milestone id to attach to
- `zb-task-create` — create the task before attaching it to a milestone
