...
# /zb-intense-review — 2-round adversarial review + determinism hardening
...
## Usage
```
/zb-intense-review diff on dev since 31f115d (the zb-* skill batch)
```

## Related skills

- **zb-spec** — hardens the task spec before work starts; use zb-spec upstream and zb-intense-review after the change is ready.
- **zb-task-done** — the skill that flips a task to DONE; zb-intense-review is the gate that must pass before invoking zb-task-done on a bulletproof change.
