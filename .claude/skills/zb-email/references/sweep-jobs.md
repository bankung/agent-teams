...
3. Reconcile against the canonical job tracker (owned by the `zb-jobs` skill) at
   ...
   reconcile/dedup logic, hand off to `zb-jobs reconcile` (zb-jobs owns job logic).
